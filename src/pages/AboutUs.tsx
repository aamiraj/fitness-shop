    ...
    <div className="">
      <div className="container">
        ...
        <div className="px-2 py-8 md:px-8">
          <h2 className="text-center font-bold text-xl sm:text-2xl py-4">
            Our Team
          </h2>
          ...
          <div className="py-4 grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4 items-start xl:items-center">
            ...
            >
              ...
              <p className="text-base font-normal">
                Ted Rich is one of the founding member of the company. His new
                ideas and skills inspires the whole team. He is enthusiasts and
                hard-working person. Academically he is one of the topper in his
                University. He likes to debate and always likes to ask
                questions. Currently he is in the position of handling
                Marketing, Human Resource and Logistics departments. He is
                responsible for 20% growth of the company last year. He tries to
                find out the right person for the company. He recruites 4
                valuable members who helped him achieve the growth. He has a
                marvelous skill to handle the logistics efficiently. All in all
                he is one of the key members in our team.
              </p>
            </div>
          </div>
          ...
          >
            ...
            <div className="py-4 order-2 md:order-1 flex flex-col gap-2 items-end text-justify">
              ...
              <p className="text-base font-normal">
                John Doe is also one of the founding memeber. He is mainly a
                tech guy in our company. Also he knows how to handle accounts
                and finance. As our main shop is digital, a lot of the
                transactions happen digitally. He can handle them all with his
                custom built software. In his academic life he was very bright.
                He became fond of coding and problem solving at an early age,
                and since then he is working remarkably. He is the reason we
                have a digital shop, otherwise we have to go for a traditional
                shop. He always motivates our team by his hard-working
                personality. He tells the team that this company is a big
                problem and we need to work hard to solve this problem. As a
                consequence, everyone loves him and seek guidance from him.
              </p>
            </div>
